...
static const char *fonts[]          = { "monospace:size=5:antialias=true:autohint=true" };
static const char dmenufont[]       = "monospace:size=5:antialias=true:autohint=true" ;
...
static const char *firefoxbased[] = { "firefox-esr", NULL };
static const char *firefoxcringe[] = { "firefox-esr", "-P", "cringe", NULL };
